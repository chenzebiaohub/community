package com.czb.community.cache;

import com.czb.community.dto.TagDTO;
...
public class TagCache {
    public static List<TagDTO> get() {
        ...
        framework.setTags(Arrays.asList("laravel", "spring", "express", "django", "flask", "yii", "ruby-on-rail", "tornado", "tornado", "struts"));
